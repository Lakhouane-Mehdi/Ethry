...
public static class ItemRegistry
{
	...
	public static ItemCategory GetCategory(ItemType type) => type switch
	{
		...
		ItemType.Axe or ItemType.Pickaxe or ItemType.Shovel or ItemType.FishingRod
			=> ItemCategory.Tool,
		...
		ItemType.Cheese or ItemType.CookedMeat or ItemType.Carrot or ItemType.Berry
			=> ItemCategory.Food,
	...
	public static EquipSlot? GetEquipSlot(ItemType type) => type switch
	{
		ItemType.IronSword or ItemType.GoldSword or ItemType.Spear or ItemType.Bow
			=> EquipSlot.Weapon,
		ItemType.Axe or ItemType.Pickaxe or ItemType.Shovel or ItemType.FishingRod
	...
	public static int GetArmorRating(ItemType type) => type switch
	{
	...
	public static int GetHealAmount(ItemType type) => type switch
	{
